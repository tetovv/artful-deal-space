        ...
        <BrowserRouter>
          <AuthProvider>
            <Routes>
              ...
              <Route path="/marketplace" element={<Protected><RoleGuard blockedRoles={["creator"]} fallbackUrl="/ad-studio" fallbackLabel="К моим сделкам"><Marketplace /></RoleGuard></Protected>} />
