...
export function AdvertiserSettings() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-3 px-6 pb-3 min-h-0">
          {/* 1. Brand */}
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="px-4 pb-3 space-y-2.5 flex-1">
              ...
              {!form.business_verified ? (
                <Button size="sm" variant="outline" className="gap-1.5 h-8 text-xs" onClick={() => mockVerify("business")}>
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="px-4 pb-3 space-y-2.5 flex-1">
              ...
              {!form.bank_verified ? (
                <Button size="sm" variant="outline" className="gap-1.5 h-8 text-xs" onClick={() => mockVerify("bank")}>
                  <ShieldCheck className="h-3.5 w-3.5" /> Проверить
                </Button>
              ) : (
                <div className="flex items-center gap-1.5 text-xs text-green-600">
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="px-4 pb-3 space-y-2.5 flex-1">
              ...
              <div className="rounded border border-muted px-2.5 py-1.5">
                <p className="text-xs text-muted-foreground">
                  <span className="font-medium text-foreground">ОРД:</span> Яндекс, VK, МедиаСкаут, Озон, АМОРДС
                </p>
              </div>
              {!form.ord_verified ? (
                <Button size="sm" variant="outline" className="gap-1.5 h-8 text-xs" onClick={() => mockVerify("ord")}>
